        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Join Laxmi Agro to access wholesale agricultural equipment',
                style: GoogleFonts.plusJakartaSans(
                  fontSize: 14,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Text(
                          'I agree to get calls and messages from Laxmi Agro',
                          style: GoogleFonts.plusJakartaSans(
                            fontSize: 16,
                            fontWeight: FontWeight.w700,
                  ...
                  onPressed: () {
                    if (!_hasConsentForCallsAndMessages) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Please agree to get calls and messages from Laxmi Agro'),
                        ),
                      );
                      return;
                    }
