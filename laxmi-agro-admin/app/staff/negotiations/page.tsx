...
export default function StaffNegotiationsPage() {
  ...
  const counterIsValid = Boolean(selected && counterPrice.trim() && Number.isFinite(Number(counterPrice)) && Number(counterPrice) > 0)
