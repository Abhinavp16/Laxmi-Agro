...
function getReadOnlyReason(item: Negotiation) {
  ...
  if (item.staffMinPrice === null) return "A full admin must set a minimum staff price for this product before staff can act."
  return null
}
