...
const statusFilters: { value: StatusFilter; label: string }[] = [
  ...
  { value: "accepted", label: "Order Created" },
...
function getReadOnlyReason(item: Negotiation) {
  ...
  if (item.staffMinPrice === null) return "A full admin must set a minimum dealer price for this product before staff can act."
  return null
}
...
export default function StaffNegotiationsPage() {
  ...
  async function handleAccept() {
    if (!selected) return
    if (!window.confirm(`Accept Deal & Create Order at ${formatCurrency(selected.currentPricePerUnit)} per unit for ${selected.negotiationNumber}?`)) return
